%%% Main 2 - Halo Orbit Numerical Computation 

% Numerical Computation characteristics

nmax=60; % Max. number of iteration
tol=1e-14; % Tolerance error
...
% Update IC --- Ax=B
    ...
    A=zeros(2,2);
    A(1,1) = Phifmat(4,1);   A(1,2) = Phifmat(4,5);
    A(2,1) = Phifmat(6,1);   A(2,2) = Phifmat(6,5); 
    dxvec0=A\B; % Solve inverting A
    dx0=dxvec0(1);
    dvy0=dxvec0(2);
