function [SF, etf, states, times] = PCR3BP_propagator (S0, params,...
...
derivs = @(et,state)PCR3BP_state_derivs(et,state, params);
...
options = odeset('RelTol',1e-12,'AbsTol',1e-12,'MaxStep',max_step);
