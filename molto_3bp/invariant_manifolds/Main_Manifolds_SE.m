...
%%2.1: Lagrange Points
guess_SE = [1.01,1,-1];%%What is this?
pos_SE = lagrange_points(mu_SE,guess_SE);%Returns, x and y coordinates of L points
    ...
    %Select L2 point
    Lpoint = 2;
    xe = pos_SE(Lpoint,1);%%xe=position in x of L2(it is going to smash the previous xe)
...
[SF, etf, states1_IG, times1_IG] = PCR3BP_propagator (S0, params,...
        et0, deltat, prnt_out_dt, stop_fun2);%stopfun1
...
%% c)Corrector Autonomous: Apply a differential correction algorithm using:
    ...
    Ax_tgt = 1.7e-3;%%%Why?targeted?1.7e-3
    Ax_tgt_mid = Ax_tgt;
